...
class __VggBlock(layers.Layer):
    def __init__(self,num_cn,channels):
        super(__VggBlock,self).__init__()
        self.num_cn=num_cn
        self.layers=[]
...
class VGG_19(keras.Model):
    def __init__(self) :
        ...
        self.vgg1=__VggBlock(2,64)
        self.vgg2=__VggBlock(2,128)
        self.vgg3=__VggBlock(4,256)
        self.vgg4=__VggBlock(4,512)
        self.vgg5=__VggBlock(4,512)
